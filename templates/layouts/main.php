...
// Helper function for hex to RGB conversion (used in custom colors)
...
?>
<!DOCTYPE html>
<html dir="<?= $languages[$lang]['dir'] ?? 'ltr' ?>">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
  <title><?= $pageTitle ?? 'Wallos - Subscription Tracker' ?></title>
...
<body class="<?= $theme ?> <?= $languages[$lang]['dir'] ?? 'ltr' ?> <?= $mobileNavigation ?>">
  <header>
    <div class="contain">
      <div class="logo">
        <a href=".">
          <div class="logo-image" title="Wallos - Subscription Tracker">
            <?php include __DIR__ . "/../../images/siteicons/svg/logo.php"; ?>
          </div>
        </a>
      </div>
      <nav>
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            <a href="." class="mobileNavigationHideOnMobile">
              <?php include __DIR__ . "/../../images/siteicons/svg/mobile-menu/home.php"; ?>
              <?= translate('dashboard', $i18n) ?></a>
            <a href="subscriptions.php" class="mobileNavigationHideOnMobile">
              <?php include __DIR__ . "/../../images/siteicons/svg/mobile-menu/subscriptions.php"; ?>
              <?= translate('subscriptions', $i18n) ?></a>  
            <a href="calendar.php" class="mobileNavigationHideOnMobile">
                <?php include __DIR__ . "/../../images/siteicons/svg/mobile-menu/calendar.php"; ?>
                <?= translate('calendar', $i18n) ?></a>
            <a href="stats.php" class="mobileNavigationHideOnMobile">
              <?php include __DIR__ . "/../../images/siteicons/svg/mobile-menu/statistics.php"; ?>
              <?= translate('stats', $i18n) ?></a>
            <a href="settings.php" class="mobileNavigationHideOnMobile">
              <?php include __DIR__ . "/../../images/siteicons/svg/mobile-menu/settings.php"; ?>
              <?= translate('settings', $i18n) ?></a>
            <a href="profile.php">
              <?php include __DIR__ . "/../../images/siteicons/svg/mobile-menu/profile.php"; ?>
              <?= translate('profile', $i18n) ?></a>  
            <?php if ($isAdmin): ?>
              <a href="admin.php">
                <?php include __DIR__ . "/../../images/siteicons/svg/mobile-menu/admin.php"; ?>
                <?= translate('admin', $i18n) ?>
              </a>
            <?php endif; ?>
            <a href="about.php">
              <?php include __DIR__ . "/../../images/siteicons/svg/mobile-menu/about.php"; ?>
            ...
            if ($settings['disableLogin'] == 0) {
              ?>
              <a href="logout.php">
                <?php include __DIR__ . "/../../images/siteicons/svg/mobile-menu/logout.php"; ?>
